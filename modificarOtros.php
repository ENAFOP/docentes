...
$manejador=new SeedDMS_Core_DatabaseAccess($driver,$host,$user,$pass,$base);
  ...
  $modificar="UPDATE otros  SET $name = '$value' WHERE id=$pk;";
		  ...
		  $historico="INSERT INTO historial VALUES (NULL,$idpostulacion,'$estadopostulacion',NOW(),'Cambios realizados en la sección de otros datos')";
