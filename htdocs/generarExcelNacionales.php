...
///////////////////////// OBTENGO PARÁMETROS DESDE EL FORMULARIO
	...
	$postulantesNacionales=$_GET["postulantesNacionales"];
  $postulantesExtranjeros=$_GET["postulantesExtranjeros"];
  $aprobadosExtranjeros=$_GET["aprobadosExtranjeros"];
  $aprobadosNacionales=$_GET["aprobadosNacionales"];
  $totalExtranjeros=$_GET["totalExtranjeros"];
  $totalNacionales=$_GET["totalNacionales"];
...
$objPHPExcel->getProperties()->setCreator($creadorExcel)
							 ...
							 ->setDescription("Reporte de las estadísticas de SIGDENAFOP para la categoría nacionales vs extranjeros")
							 ->setKeywords("enafop seteplan estadisticas docentes nacionales")
...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A1', 'Estadísticas sobre postulados vs aprobados')
...
$objPHPExcel->getActiveSheet()->mergeCells('A2:C2');
 ...
 $objPHPExcel->setActiveSheetIndex(0)
            //->setCellValue('A5', 'Aprobados')
              ->setCellValue('A6', 'Postulantes')
             ->setCellValue('A7', 'Aprobados')
             ->setCellValue('A8', 'Total')
             ->setCellValue('B5', 'Nacionales')
             ->setCellValue('C5', 'Extranjeros');
...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('B6', $postulantesNacionales)
            ->setCellValue('B7', $aprobadosNacionales)
            ->setCellValue('B8', $totalNacionales)
            ->setCellValue('C6', $postulantesExtranjeros)
            ->setCellValue('C7', $aprobadosExtranjeros)
            ->setCellValue('C8', $totalExtranjeros);
            

$objPHPExcel->getActiveSheet()->setTitle("Resultado Estadísticas");


/////////////////////////////////////////////////////////////////////////////
ob_end_clean();
$nombreFicheroFinal="estadisticas_nacionales_enafop.xlsx";
