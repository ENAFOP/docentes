...
///////////////////////// OBTENGO PARÁMETROS DESDE EL FORMULARIO
	...
	$numeroAprobados=$_GET["numeroAprobados"];
  $numeroPostulantes=$_GET["numeroPostulantes"];
...
$objPHPExcel->getActiveSheet()->mergeCells('A2:C2');
 ...
 $objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A5', 'Aprobados')
             ->setCellValue('B5', 'Postulados')
             ->setCellValue('C5', 'Ratio postulados/aprobados');
...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A6', $numeroAprobados)
            ->setCellValue('B6', $numeroPostulantes)
            ->setCellValue('C6', $ratio);
...
/////////////////////////////////////////////////////////////////////////////
ob_end_clean();
$nombreFicheroFinal="estadisticas_aprobados_enafop.xlsx";
