...
$manejador=new SeedDMS_Core_DatabaseAccess($driver,$host,$user,$pass,$base);
  ...
  $modificar="UPDATE titulos_otros SET $name = '$value' WHERE id=$pk;";
		  ...
		  $historico="INSERT INTO historial VALUES (NULL,$idpostulacion,'$estadopostulacion',NOW(),'Cambios realizados en la sección de formación académica (otros estudios se editó $value)')";
