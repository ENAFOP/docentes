...
///////////////////////// OBTENGO PARÁMETROS DESDE EL FORMULARIO
	...
	$numGeneroMasculinosPostulantes=$_GET["numGeneroMasculinosPostulantes"];
  $numGeneroFemeninosPostulantes=$_GET["numGeneroFemeninosPostulantes"];
  $numGeneroOtrosPostulantes=$_GET["numGeneroOtrosPostulantes"];

  $numGeneroMasculinosAprobados=$_GET["numGeneroMasculinosAprobados"];
  $numGeneroFemeninosAprobados=$_GET["numGeneroFemeninosAprobados"];
  $numGeneroOtrosAprobados=$_GET["numGeneroOtrosAprobados"];

  $numGeneroMasculinosTotal=$_GET["numGeneroMasculinosTotal"];
  $numGeneroFemeninosTotal=$_GET["numGeneroFemeninosTotal"];
  $numGeneroOtrosTotal=$_GET["numGeneroOtrosTotal"];
...
$objPHPExcel->getProperties()->setCreator($creadorExcel)
							 ...
							 ->setDescription("Reporte de las estadísticas de SIGDENAFOP para la categoría género de los postulantes")
							 ->setKeywords("enafop seteplan estadisticas docentes genero")
...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A1', 'Estadísticas sobre género de los postulantes')
...
$objPHPExcel->getActiveSheet()->mergeCells('A2:C2');
 ...
 $objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A5', 'Estado')
             ->setCellValue('B5', 'Masculino')
            ->setCellValue('C5', 'Femenino')
             ->setCellValue('D5', 'Otro');
...
$profesiones=array("Postulantes","Aprobados","Total");
...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('B6', $numGeneroMasculinosPostulantes)
            ->setCellValue('C6', $numGeneroFemeninosPostulantes)
            ->setCellValue('D6', $numGeneroOtrosPostulantes)

            ->setCellValue('B7', $numGeneroMasculinosAprobados)
            ->setCellValue('C7', $numGeneroFemeninosAprobados)
            ->setCellValue('D7', $numGeneroOtrosAprobados)

             ->setCellValue('B8', $numGeneroMasculinosTotal)
            ->setCellValue('C8', $numGeneroFemeninosTotal)
            ->setCellValue('D8', $numGeneroOtrosTotal);



$objPHPExcel->getActiveSheet()->setTitle("Resultado estadísticas género");


/////////////////////////////////////////////////////////////////////////////
ob_end_clean();
$nombreFicheroFinal="estadisticas_genero_enafop.xlsx";
