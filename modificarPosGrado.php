...
$manejador=new SeedDMS_Core_DatabaseAccess($driver,$host,$user,$pass,$base);
  ...
  if($estado!=1)
  {
    echo "modificarCargos.php: Error: no se pudo conectar a la BD para modificar a ";
	exit;
  } 

  $modificar="UPDATE titulos_posgrado SET $name = '$value' WHERE id=$pk;";
		  ...
		  $historico="INSERT INTO historial VALUES (NULL,$idpostulacion,'$estadopostulacion',NOW(),'Cambios realizados en la sección de formación académica (estudios de posgrado se editó $value)')";
