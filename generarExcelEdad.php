...
/** Include PHPExcel */
//$ruta= dirname(__FILE__) . '/Classes/PHPExcel.php';
//echo "Ruta: ".$ruta; exit;
...
///////////////////////// OBTENGO PARÁMETROS DESDE EL FORMULARIO
  ...
  $edadMediaPostulados=$_GET["edadMediaPostulados"];
	$edadMediaAprobados=$_GET["edadMediaAprobados"];
  $edadMediaTotal=$_GET["edadMediaTotal"];
...
$objPHPExcel->getProperties()->setCreator($creadorExcel)
							 ...
							 ->setDescription("Reporte de las estadísticas de SIGDENAFOP para la categoría aprobados vs postulados")
...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('B6', $edadMediaPostulados)
            ->setCellValue('B7', $edadMediaAprobados)
            ->setCellValue('B8', $edadMediaTotal);
            

$objPHPExcel->getActiveSheet()->setTitle("Resultado Estadísticas Edad");


/////////////////////////////////////////////////////////////////////////////
ob_end_clean();
$nombreFicheroFinal="estadisticas_edad_enafop.xlsx";
