...
///////////////////////// OBTENGO PARÁMETROS DESDE EL FORMULARIO
	...
	$numDocenciaAprobados=$_GET["numDocenciaAprobados"];
  $numDocenciaPostulados=$_GET["numDocenciaPostulados"];
  $numDocenciaTotal=$_GET["numDocenciaTotal"];
...
$objPHPExcel->getProperties()->setCreator($creadorExcel)
							 ...
							 ->setDescription("Reporte de las estadísticas de SIGDENAFOP para la categoría práctica de la docencia")
							 ->setKeywords("enafop seteplan estadisticas docentes practica docencia")
...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A1', 'Estadísticas sobre práctica de la docencia')
...
$objPHPExcel->getActiveSheet()->mergeCells('A2:C2');
 ...
 $objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A5', '
Aprobados que practican la docencia')
             ->setCellValue('B5', 'Postulados que practican la docencia')
...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A6', $numDocenciaAprobados)
            ->setCellValue('B6', $numDocenciaPostulados)
            ->setCellValue('C6', $numDocenciaTotal);
...
/////////////////////////////////////////////////////////////////////////////
ob_end_clean();
$nombreFicheroFinal="estadisticas_prac_docencia_enafop.xlsx";
