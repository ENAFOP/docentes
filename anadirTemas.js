...
{
    console.log( "a modificar temas!" );
	$.fn.editable.defaults.mode = 'inline';
	$('[id^="abierto_"]').editable();
	$('[id^="gerencia"]').editable();
	$('[id^="planificacion"]').editable();
	$('[id^="talento"]').editable();
	$('[id^="gobierno"]').editable();
	$('[id^="etica"]').editable();
	$('[id^="electronico"]').editable();
	$('[id^="calidad"]').editable();
	$('[id^="enfoque"]').editable();
	$('[id^="relaciones"]').editable();
	$('[id^="capacitacion"]').editable();
