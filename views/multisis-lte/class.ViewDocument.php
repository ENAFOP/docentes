...
<?php
	...
	function show() { /* {{{ */
		...
		if($user->isAdmin())
		{
			$this->htmlStartPage(getMLText("folder_title", array("foldername" => htmlspecialchars("Ver postulación"))), "skin-blue sidebar-mini sidebar-collapse");
		}
		else
		{
			$this->htmlStartPage(getMLText("folder_title", array("foldername" => htmlspecialchars("Ver postulación"))), "skin-blue layout-top-nav");
		}
...
<?php
    ...
    print "</ul></td>\n";
      ...
      print "</ul></td>\n";
		...
		//comentado por Mario, no necesito "Cambiar estado"
